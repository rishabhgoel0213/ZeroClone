...
from engine.engine import Engine, History                                  # type: ignore
import models.core as core                                                  # type: ignore
...
def train_and_save_latest(model_type: str,
    ...
    """(Re)train the latest value net & archive previous weights."""
...
def simulate_games(engine: Engine, total_games: int) -> List[int | None]:
    """Play ``total_games`` games in parallel and return their final results."""
...
def full_training_run(config_path: str,
    ...
    """Execute a multi‑cycle self‑play/training campaign."""
...
if __name__ == "__main__":
    ...
    ap.add_argument("-c", "--config", required=True,
                    help="Config name (without .yaml) located under ./configs/")
